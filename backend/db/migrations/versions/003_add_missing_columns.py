...
down_revision: str | None = "002_add_enum_values"
...
def downgrade() -> None:
    ...
    for idx in [
        ...
        op.execute(f"DROP INDEX IF EXISTS {idx}")  # noqa: S608
    ...
    for tbl, col in [
        ...
        ("users", "is_active"),
        ("users", "last_login"),
        ("shipments", "tracking_num"),
        ("shipments", "current_lat"),
        ("shipments", "current_lon"),
        ("shipments", "risk_score"),
        ("shipments", "route_id"),
        ("shipments", "sla_deadline"),
        ("shipments", "eta_current"),
        ("shipments", "co2_kg"),
        ("route_segments", "tenant_id"),
        ("route_segments", "highway_code"),
        ("route_segments", "risk_score"),
        ("route_segments", "elevation_avg_m"),
        ("route_segments", "flood_prob"),
        ("route_segments", "fire_risk"),
        ("route_segments", "congestion_idx"),
        ("route_segments", "last_scored_at"),
        ("carriers", "modes"),
        ("carriers", "rating"),
        ("carriers", "avg_delay_h"),
        ("carriers", "cost_per_km"),
        ("carriers", "co2_per_tonne_km"),
        ("carriers", "available_now"),
        ("carriers", "verified_at"),
        ("telemetry", "tenant_id"),
        ("telemetry", "lat"),
        ("telemetry", "lon"),
        ("telemetry", "speed_kmh"),
        ("telemetry", "heading"),
        ("telemetry", "accuracy_m"),
        ("telemetry", "source"),
        ("telemetry", "battery_pct"),
        ("subscription_events", "razorpay_event_id"),
